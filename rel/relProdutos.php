	...
	<div class="cabecalho">
		<div class="row titulos">
			<div class="col-sm-2 esquerda_float image">	
				<img src="<?php echo $url_sistema ?>img/logo_daupause.jpg" width="80px">
			</div>
...
<table class='table' width='100%'  cellspacing='0' cellpadding='3'>
			...
			$query = $pdo->query("SELECT * FROM produtos order by id desc");
				...
				<tr>
					...
					<td> <img src="<?php echo $url_sistema ?>img/produtos/<?php echo $foto?>" width="30px">   </td>
		...
		<div class="row margem-superior">
			<div class="col-md-12">
				<div class="" align="right">
					...
					<span class=""> <b> Total Produtos <?php echo $total_itens ?> </b> </span>
				</div>
