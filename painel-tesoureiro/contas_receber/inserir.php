...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO contas_receber SET vencimento = :vencimento, pago = 'Não', data = curDate(), usuario = '$id_usuario', descricao = :descricao, valor = :valor, arquivo = :foto");
	...
	if($imagem != 'sem-foto.jpg'){
		$res = $pdo->prepare("UPDATE contas_receber SET vencimento = :vencimento, usuario = '$id_usuario', descricao = :descricao, valor = :valor, arquivo = :foto WHERE id = :id");
		$res->bindValue(":foto", $imagem);
	}else{
