...
if($total_reg > 0){ 
	...
	echo '<div class="row"><div class="col-md-9"><h1>R$ <span id="sub_total">'.$total_vendaF.'</span></h1></div><div class="col-md-3" align="right" > <a style="text-decoration:none" href="index.php" title="Sair do PDV"> <i class="bi bi-box-arrow-right"></i> <small> Sair </small> </a> </div> ';
}
